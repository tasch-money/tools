...
FRAME_COMMS_LAYOUT = [
    ...
    [sg.Text('Status:',size=(8,1),font=GUI_FONT_MAIN),LEDIndicator(key='gui_status_comms',radius=14),sg.Text('',size=(8,1),font=GUI_FONT_MAIN,key='gui_text_comms_stat'),sg.T('',size=(24,1)),sg.Button('REFRESH',size=(14,1), key='gui_button_refresh_port')],
]
